    ...
    $(function() {
        ...
        $.ajax({
            ...
            'success': function(obj){
                ...
                content += "Phone: " + obj.phone + "<br/>";
                content += "Website: " + obj.website + "<br/>";
                content += "Company: " + obj.company.name + "<br/>";
                content += "</div>";
...
http://jsonplaceholder.typicode.com/posts?users/1
